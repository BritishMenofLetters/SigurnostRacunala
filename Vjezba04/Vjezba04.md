...
if __name__ == "__main__":
    ...
    TESTS = [
        ...
        }
        {
            ...
            "service": lambda: linux_hash(password, rounds=10*10**4 measure=True)
        }
    ]
...
**Pokretanjem kôda se dobiju sljedeće vrijednosti**
...
| HASH_MD5 | 3.53-05 |
| AES | 0.000479 |
| Linux CRYPT | 0.006857 |
| Linux CRYPT 10k | 0.013696 |
| Linux CRYPT 50k | 0.0658924 |
| Linux CRYPT 100k | 0.128659 |

**Zaključuje se da se što više iterativnih heširanja primjeni nad istim podatkom to će vrijeme povećavati.**